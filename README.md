...
### 4. Advanced Selection (Tags & Flows)
Run specific subsets of tests using `run_tests.py` and Pytest markers:
...
**Run Critical Tests:**
```bash
python3 scripts/run_tests.py -m critical
```

**Run Specific Business Module:**
```bash
python3 scripts/run_tests.py -m business_a
```
